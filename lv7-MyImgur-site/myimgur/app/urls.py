...
urlpatterns = [     # naziv viewa i naziv rute nije povezan!
    ...
    path('<int:image_id>/approve_comment/<int:comment_id>/', views.ApproveComment, name="approve_comment"),
    #path('<int:image_id>/commentApprove/<int:comment_id>/', views.commentApprove, name='commentApprove'),
